...
import com.skyrimcraft.mod.crafting.ToolForgeCraftingManager;
...
public class ContainerToolForge extends Container {
	...
	public ContainerToolForge(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iinventory) {
		craftResult.setInventorySlotContents(0, ToolForgeCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != SCDecs.blockToolForge) {
			return false;
		}else {
