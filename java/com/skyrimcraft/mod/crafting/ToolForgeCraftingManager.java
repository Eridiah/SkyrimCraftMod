...
public class ToolForgeCraftingManager {

    private static final ToolForgeCraftingManager instance = new ToolForgeCraftingManager();
     ...
     */
    public static final ToolForgeCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private ToolForgeCraftingManager()
    {
    	recipes = new ArrayList();

        Collections.sort(this.recipes, new ToolForgeRecipeSorter(this));
    }

    public ToolForgeShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        ToolForgeShapedRecipes shapedrecipes = new ToolForgeShapedRecipes(j, k, aitemstack, p_92103_1_);
