...
public class ToolForgeShapedRecipes {
    ...
    public ToolForgeShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public ToolForgeShapedRecipes func_92100_c()
    {
